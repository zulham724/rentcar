...
Route::group(['middleware' => ['auth']], function (){
  ...
  Route::get('/return','RentController@return')->name('rent-return');
  Route::post('/return','RentController@returnByPlat')->name('rent-return-by-plat');

  Route::get('/report','RentController@report')->name('rent-report');
});
// layout
...
// authentication
Route::get('/auth/login-basic', 'authentications\LoginBasic@index')->name('login');
Route::get('/auth/register-basic', 'authentications\RegisterBasic@index')->name('register');
Route::get('/auth/forgot-password-basic', 'authentications\ForgotPasswordBasic@index')->name('reset_password');
