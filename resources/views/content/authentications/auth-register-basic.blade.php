                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="/register" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phone_address" name="phone_number"
                                    placeholder="Masukan nomer telefon">
                            </div>
                            <div class="mb-3">
                                <label for="sim_number" class="form-label">Masukan Nomor SIM</label>
